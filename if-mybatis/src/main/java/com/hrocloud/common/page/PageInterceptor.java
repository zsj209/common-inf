 ...
 */
package com.hrocloud.common.page;
...
public class PageInterceptor implements Interceptor {
    ...
    private void setPageParameter(String sql, Connection connection, MappedStatement mappedStatement,
        ...
        try {
            ...
            page.setPrePage(page.getCurrentPage() > 1 ? page.getCurrentPage() - 1 : 0);
            page.setNextPage(page.getCurrentPage() >= totalPage ? 0 : page.getCurrentPage() + 1);
