...
public class CaptchaUtil {
    ...
    /**
     * @param length 验证码文本位数
     * @param type   文本类型
     * @param total  总共需要生成的数量
     * @return
     */
     ...
     * @param length    验证码文本位数
     * @param type      文本类型
     * @param number    本次需要生成的数量
     * @param total     总共需要生成的数量
     * @param beginCode 起始验证码文本
     * @return
     */
    public static List<String> createCaptchaValues(int length, CaptchaValueType type, int number, int total,
                                                   String beginCode) {
    ...
    public static void main(String[] args) {
        ...
        List<String> capList = createCaptchaValues(4, CaptchaValueType.CHARACTER_AND_DIGIT, 100);
